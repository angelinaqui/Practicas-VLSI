...
ARCHITECTURE structure OF ejer1 IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
SIGNAL \conteo[1]~0_combout\ : std_logic;
SIGNAL \conteo[2]~1_combout\ : std_logic;
SIGNAL \conteo[3]~2_combout\ : std_logic;
...
\conteo[1]~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
...
\conteo[3]~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
